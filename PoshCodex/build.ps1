...
task Init {
	...
	# Just manually create the Docs and Test directories.
	# (because calling the Build task when any of these folders doesn't exist throws an error)
	New-Item -ItemType Directory -Force -Path ".\Source\Docs\"
	New-Item -ItemType Directory -Force -Path ".\Source\Test\"
}
